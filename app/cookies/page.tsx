...
export default function CookiesPage() {
  return (
    <div className="min-h-screen bg-[#02091A] py-20 px-6 sm:px-12 lg:px-24 text-gray-300 font-sans">
      <div className="max-w-4xl mx-auto">
        
        {/* Header */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-12 gap-4 border-b border-white/10 pb-6">
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">You control how non-essential cookies are used.</p>
            <ul className="list-disc pl-5 space-y-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">Legal bases & region notes</h2>
            <p className="leading-relaxed">
