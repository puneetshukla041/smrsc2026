...
const Overview = dynamic(() => import('../../../components/agenda/Overview'), {
  ssr: false, 
  loading: () => <div className="min-h-[50vh] flex items-center justify-center text-white/50">Loading Overview...</div>
});
const ScheduleDay1 = dynamic(() => import('../../../components/agenda/ScheduleDay1'), {
  ssr: false,
  loading: () => <p className="text-white text-center py-10">Loading Day 1...</p>
});
const ScheduleDay2 = dynamic(() => import('../../../components/agenda/ScheduleDay2'), {
  ssr: false,
  loading: () => <p className="text-white text-center py-10">Loading Day 2...</p>
});
const ScheduleDay3 = dynamic(() => import('../../../components/agenda/ScheduleDay3'), {
  ssr: false,
  ...
  return (
    <div className="w-full mt-20 md:mt-24 mb-20 relative">
      ...
      <motion.h2 
        ...
        // Adjusted text size for laptops (lg:text-3xl)
    ...
    <main className="flex-grow w-full flex flex-col items-center overflow-x-hidden">
        ...
        <section className="w-full bg-transparent flex flex-col items-center">
          ...
          <motion.div
            ...
            // Added lg:px-16 and xl:px-24 for laptop padding
            className="relative z-10 w-full hidden md:flex justify-center mt-20 lg:mt-[98px] mb-12 lg:mb-[65px] px-6 md:px-8 lg:px-16 xl:px-24 2xl:px-8"
          >
        ...
        {loadHeavyContent && (
          <motion.div 
            ...
            // Added matching lg:px-16 and xl:px-24 padding here to align the content body
            className="flex flex-col items-center w-full max-w-[1440px] px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-8"
          >
