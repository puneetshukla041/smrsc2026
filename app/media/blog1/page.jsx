      ...
      <div style={{ display: 'flex', width: '100%', maxWidth: '1380px', margin: '0 auto', padding: '32px 80px', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '36px', background: '#FFF' }}>
        ...
        <div style={{ width: '100%', maxWidth: '1193px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <p style={{ color: '#03101F', fontFamily: 'Manrope', fontSize: '16px', fontStyle: 'normal', fontWeight: '600', lineHeight: '26px', letterSpacing: '-0.16px', margin: 0 }}>
            A Hard Question for Atmanirbhar Bharat
          </p>
          ...
          <p style={{ color: '#03101F', fontFamily: 'Manrope', fontSize: '16px', fontStyle: 'normal', fontWeight: '400', lineHeight: '26px', letterSpacing: '-0.16px', margin: 0 }}>
            There is a quiet, resonant pride that comes with the words Made in India. It is a phrase that carries the weight of history and the ambition of a nation that no longer wants to be seen merely as a massive consumer market—but as a global maker. But as we accelerate toward a <span style={{ fontWeight: '600' }}>$5 trillion economy</span>, an uncomfortable question has begun to surface: <span style={{ fontWeight: '600' }}>When we say "Made in India," do we mean engineered in India—or merely assembled here?</span> The difference isn't semantic. It is structural. It is the difference between a nation that owns its future and one that merely rents its progress.
          </p>

          <p style={{ color: '#03101F', fontFamily: 'Manrope', fontSize: '16px', fontStyle: 'normal', fontWeight: '600', lineHeight: '26px', letterSpacing: '-0.16px', margin: 0 }}>The "Costume" of Self-Reliance</p>

          <p style={{ color: '#03101F', fontFamily: 'Manrope', fontSize: '16px', fontStyle: 'normal', fontWeight: '400', lineHeight: '26px', letterSpacing: '-0.16px', margin: 0 }}>
            In several high-technology sectors, a pattern is emerging. Advanced systems arrive at our shores largely complete—sometimes fully built, sometimes in semi-knocked-down (SKD) kits. A logo changes. A housing is redesigned. Final assembly takes place domestically. We see record-breaking production numbers, yet the "depth" of that manufacturing remains thin. Consider the electronics sector: while mobile phone production has skyrocketed <span style={{ fontWeight: '600' }}>28x since 2014</span> (reaching <span style={{ fontWeight: '600' }}>₹5.5 lakh crore in FY25</span>), much of this growth is driven by final-stage assembly.
          </p>

          <p style={{ color: '#03101F', fontFamily: 'Manrope', fontSize: '16px', fontStyle: 'normal', fontWeight: '400', lineHeight: '26px', letterSpacing: '-0.16px', margin: 0 }}>
            On paper, these products qualify as indigenous. <span style={{ fontWeight: '600' }}>In spirit, do they?</span>
          </p>
