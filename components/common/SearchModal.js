...
export default function SearchModal({ isOpen, onClose }) {
  ...
  // Use ref for handler to avoid recreating event listeners
  ...
  // Create stable callback with useCallback to avoid ref updates
  ...
  }, [isOpen]); // Only re-add listener when isOpen changes
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 py-4 sm:py-5 border-b border-white/[0.08] bg-white/[0.02]">
              <Search className="text-white/40 flex-shrink-0" size={22} strokeWidth={1.5} aria-hidden="true" />
              <input
            ...
            {/* RESULTS BODY */}
            <div className="overflow-y-auto p-2 scrollbar-hide flex-1 overscroll-contain" role="listbox">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`hidden sm:flex transition-all duration-200 items-center gap-2 ${
                        ...
                        <CornerDownLeft size={16} className="text-white/50" strokeWidth={1.5} aria-hidden="true" />
                      </div>
                    </motion.button>
                  );
                })}
